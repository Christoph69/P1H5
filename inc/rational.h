...
bool rational_equal(rational,
                    rational);

// Vergleich auf Ungleichheit
bool rational_unequal(rational,
                      rational);

// Vergleich auf kleiner als
bool rational_less(rational,
                   rational);

// Vergleich auf kleiner oder gleich als
bool rational_less_or_equal(rational,
                            rational);

// Vergleich auf größer als
bool rational_greater(rational,
                      rational);
